...
**** Verify the firestore database works as expected
If you want to manually create the database using =google-cloud-cli=:
#+begin_src shell
# Enable the API
...
Now to test Firestore datbase with curl:
#+begin_src shell
